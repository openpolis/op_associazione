...
def parse(kwargs):
	...
	if jquery:
		...
		html += '<embed src="http://www.youtube.com/v/{{ id }}&hl=en&fs=1" wmode="transparent" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="{{ width }}" height="{{ height }}"></embed>'
		html += '</object>'
